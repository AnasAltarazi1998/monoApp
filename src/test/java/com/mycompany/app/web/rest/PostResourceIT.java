...
import com.mycompany.app.repository.PostRepository;
import com.mycompany.app.service.PostService;
import com.mycompany.app.service.dto.PostDTO;
import com.mycompany.app.service.mapper.PostMapper;
...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().title(DEFAULT_TITLE).content(DEFAULT_CONTENT).createdAt(DEFAULT_CREATED_AT);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().title(UPDATED_TITLE).content(UPDATED_CONTENT).createdAt(UPDATED_CREATED_AT);
        return post;
    }
