...
import com.mycompany.app.repository.CommentRepository;
import com.mycompany.app.service.dto.CommentDTO;
import com.mycompany.app.service.mapper.CommentMapper;
...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().title(DEFAULT_TITLE).createdAt(DEFAULT_CREATED_AT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().title(UPDATED_TITLE).createdAt(UPDATED_CREATED_AT);
        return comment;
    }
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.title(UPDATED_TITLE).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.title(UPDATED_TITLE).createdAt(UPDATED_CREATED_AT);
